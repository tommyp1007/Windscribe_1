...
class ViewModels: Assembly {
    func assemble(container: Container) {
        ...
        container.register((any AntiCensorshipOptionsViewModel).self) { r in
            AntiCensorshipOptionsViewModelImpl(
                logger: r.resolve(FileLogger.self)!,
                lookAndFeelRepository: r.resolve(LookAndFeelRepositoryType.self)!,
                hapticFeedbackManager: r.resolve(HapticFeedbackManager.self)!,
        ...
        container.register((any DiscreetAppIconSelectionViewModel).self) { r in
            DiscreetAppIconSelectionViewModelImpl(
                logger: r.resolve(FileLogger.self)!,
                lookAndFeelRepository: r.resolve(LookAndFeelRepositoryType.self)!,
                hapticFeedbackManager: r.resolve(HapticFeedbackManager.self)!,
                preferences: r.resolve(Preferences.self)!
        ...
        container.register(LocationPermissionManaging.self) { r in
            LocationPermissionManager(connectivityManager: r.resolve(ProtocolManagerType.self)!, logger: r.resolve(FileLogger.self)!, connectivity: r.resolve(ConnectivityManager.self)!, wifiManager: r.resolve(WifiManager.self)!)
        }.inObjectScope(.container)
        ...
        container.register(ConnectionStateInfoViewModelType.self) { r in
            ConnectionStateInfoViewModel(vpnStateRepository: r.resolve(VPNStateRepository.self)!,
                                         ...
                                         preferences: r.resolve(Preferences.self)!,
                                         protocolManager: r.resolve(ProtocolManagerType.self)!,
                                         connectivityManager: r.resolve(ConnectivityManager.self)!,
                                         wifiManager: r.resolve(WifiManager.self)!)
        }.inObjectScope(.transient)
