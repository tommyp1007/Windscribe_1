    ...
    func assemble(container: Swinject.Container) {
        ...
        container.register(LoginView.self) { r in
            LoginView(viewModel: LoginViewModelImpl(
                    ...
                    logger: r.resolve(FileLogger.self)!,
                    hashAuthManager: r.resolve(HashAuthManager.self)!
                ), router: r.resolve(AuthenticationNavigationRouter.self)!)
        }.inObjectScope(.transient)
        ...
        container.register(AntiCensorshipOptionsView.self) { r in
            AntiCensorshipOptionsView(
                viewModel: AntiCensorshipOptionsViewModelImpl(
                    logger: r.resolve(FileLogger.self)!,
                    lookAndFeelRepository: r.resolve(LookAndFeelRepositoryType.self)!,
                    hapticFeedbackManager: r.resolve(HapticFeedbackManager.self)!,
        ...
        container.register(RobertSettingsView.self) { r in
            RobertSettingsView(
                viewModel: RobertSettingsViewModelImpl(
                    ...
                    hapticFeedbackManager: r.resolve(HapticFeedbackManager.self)!,
                    apiManager: r.resolve(APIManager.self)!,
                    robertyFiltersRepository: r.resolve(RobertyFiltersRepository.self)!
                )
            )
        }.inObjectScope(.transient)
        ...
        container.register(LookAndFeelSettingsView.self) { r in
            LookAndFeelSettingsView(
                viewModel: LookAndFeelSettingsViewModelImpl(
                    ...
                    router: r.resolve(LookAndFeelNavigationRouter.self)!
                )
            )
        }.inObjectScope(.transient)

        container.register(DiscreetAppIconSelectionView.self) { r in
            DiscreetAppIconSelectionView(
                viewModel: DiscreetAppIconSelectionViewModelImpl(
                    logger: r.resolve(FileLogger.self)!,
                    lookAndFeelRepository: r.resolve(LookAndFeelRepositoryType.self)!,
                    hapticFeedbackManager: r.resolve(HapticFeedbackManager.self)!,
                    preferences: r.resolve(Preferences.self)!
        ...
        container.register(ConnectionStateInfoView.self) { r in
            ConnectionStateInfoView(wifiManager: r.resolve(WifiManager.self)!)
        }.initCompleted { r, c in
            c.viewModel = r.resolve(ConnectionStateInfoViewModelType.self)
        }.inObjectScope(.transient)

        container.register(IPInfoView.self) { r in
            IPInfoView(wifiManager: r.resolve(WifiManager.self)!)
        }.initCompleted { r, c in
        ...
        container.register(LocationsListTableViewDataSource.self) { r in
            LocationsListTableViewDataSourceImpl(locationsManager: r.resolve(LocationsManager.self)!,
                                                 lookAndFeelRepository: r.resolve(LookAndFeelRepositoryType.self)!,
                                                 hapticFeedbackManager: r.resolve(HapticFeedbackManager.self)!,
                                                 preferences: r.resolve(Preferences.self)!,
                                                 locationListRepository: r.resolve(LocationListRepository.self)!,
