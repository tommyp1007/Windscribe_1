...
enum Links {
    ...
    static let knowledge = "knowledge-base"
    ...
    static let learnMoreHashedLogin = base + "knowledge-base/articles/hashed-login/"
    static let itmsLink = "itms-apps://itunes.apple.com/app/id\(DefaultValues.appID)"
}
