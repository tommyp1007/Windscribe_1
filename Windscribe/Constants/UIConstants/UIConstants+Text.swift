...
/// Canonical VPN protocol values used for persistence/configuration plus their UI display names.
/// `identifier` is the stored/config value; `displayName` is what UI lists should render.
enum VPNProtocolType: String, CaseIterable {
    ...
    static var openVPNTypes: [VPNProtocolType] {
        [.udp, .tcp, .stealth, .wsTunnel]
    }

    static var openVPNIdentifiers: [String] {
        openVPNTypes.map(\.identifier)
    }

    static var proxiedOpenVPNIdentifiers: [String] {
        [VPNProtocolType.stealth, .wsTunnel].map(\.identifier)
    }

    static var openVPNDisplayNames: [String] {
        openVPNTypes.map(\.displayName)
    }
}
...
enum TextsAsset {
    ...
    static var gotVoucherCode: String {
        return "Got Voucher Code?".localized
    }

    static var hashedTabExplanation: String {
        return "This is your unique account hash, save it somewhere safe, you'll need it to login.".localized
    }

    static var hashedBackupConfirmation: String {
        return "I have backed up my account hash securely and understand that Windscribe will not be able to help me recover my account if I lose it.".localized
    }

    static var alreadyHaveAccount: String {
        return "Already have an account?".localized
    }

    static var accountHash: String {
        return "Account Hash".localized
    }

    static var enterAccountHashOrUpload: String {
        return "Enter Account Hash or Upload".localized
    }

    static var twoFATitle: String {
        return "2FA".localized
    }

    static var addTwoFA: String {
        return "Add 2FA".localized
    }

    static var twoFADescription: String {
        return "Check your preferred one-time password application for a code.".localized
    }

    static var enterTwoFACode: String {
        return "Enter 2FA Code".localized
    }
    ...
    static var copiedToClipboard: String {
        return "Copied to Clipboard!".localized
    }
    ...
    enum UpdateAlert {
        ...
        static var message: String {
            return "A new version of Windscribe is available.".localized
        }

        static var messageWithVersion: String {
            return "Windscribe version %@ is now available.".localized
        }

        static var updateNow: String {
            return "Update Now".localized
        }

        static var updateLater: String {
            return "Update Later".localized
        }

        static var forceTitle: String {
            return "Update Required".localized
        }

        static var forceMessage: String {
            return "This version of Windscribe is no longer supported. Please update to continue using the app.".localized
        }

        static var forceMessageWithVersion: String {
            return "This version of Windscribe is no longer supported. Please update to %@ to continue using the app.".localized
        }
    }
    ...
    enum Connection {
        ...
        static var configuration: String { "Configuration".localized }
        static var ipStack: String { "IP Stack".localized }
        static var egress: String { "Egress (WireGuard only)".localized }
        static var ingress: String { "Ingress".localized }
        static var antiCensorshipOptions: String { return "Anti-censorship Settings".localized }
        static var antiCensorshipTitle: String { "Anti-censorship".localized }
        static var circumventCensorship: String { return "Circumvent Censorship".localized }
        static var serverRouting: String { "Server Routing".localized }
        ...
        static var ipStackDescription: String {
            "Configure IP stack for VPN connections.".localized
        }
        ...
        static var networkOptionsDescription: String {
            return "The Network Options feature lets you control how the Windscribe app behaves on different networks.".localized
        }
        ...
        static var autoSecureNewDescription: String {
            return "Windscribe will mark every new network as “Secured” and your VPN will remain connected when your device connects to them.".localized
        }
        ...
        static var protocolTweaksDescription: String {
            return "Protocol-level changes made to Wireguard, OpenVPN and Stealth protocols".localized
        }

        static var serverRoutingDescription: String {
            return "Increases latency, but improves chances of being able to connect".localized
        }

        static var antiCensorshipInfoDescription: String {
            return "These degrade performance, enable only if Windscribe doesn't connect normally.".localized
        }
    }
    ...
    enum General {
        ...
        static let protocols = VPNProtocolType.allDisplayNames
        static let openVpnProtocols = VPNProtocolType.openVPNDisplayNames
        ...
        static var showServerNetLoad: String { "Location Load".localized }
        static var enabled: String { "Enabled".localized }
        static var disabled: String { "Disabled".localized }
        static var ipv4Only: String { "IPv4 Only".localized }
        ...
        static func getValue(displayText: String) -> String? {
            ...
            case TextsAsset.General.showServerNetLoad:
                return Fields.showServerNetLoad
            default:
                return nil
            }
        }
    ...
    enum LookFeel {
        ...
        static var discreetAppIconTitle: String {
            "App Icon".localized
        }
        ...
        static var discreetAppIconDescription: String {
            "Choose a different app icon for even more privacy".localized
        }
    ...
    enum Account {
        ...
        static var lazyLoginDescription: String {
            return "Enter the code shown on your tv screen to Log into Windscribe’s TV app".localized
        }
    ...
    enum NewsFeed {
        ...
        static var loadErrorMessage: String {
            return "Sorry, we couldn't load your news feed!\n\nPlease try again later, or check your internet connection.".localized
        }
    }
    ...
    static var ipStackOptions: [String] {
        return [TextsAsset.General.auto, TextsAsset.General.ipv4Only]
    }

    static let http = "http"
    static let icmp = "icmp"
    static let openVPN = "OpenVPN"
    static let iKEv2 = VPNProtocolType.iKEv2.displayName
    static let wireGuard = VPNProtocolType.wireGuard.displayName
    ...
    enum Authentication {
        ...
        static var captchaDescription: String {
            return "Complete CAPTCHA".localized
        }

        static var captchaSliderDescription: String {
            return "Slide the left image into the hole on the right".localized
        }
